  ...
  return `
    <header class="header">
      <div class="header-content">
        <div class="header-image-wrapper anim-explode-container">
          <img 
            src="img/uzkii.jpg" 
            alt="${profile.firstName}" 
            id="profileImage"
            class="link profile-image"
          />
        ...
        <div class="header-text">
          <h1 id="mainTitle" class="main-title">
            <span class="greeting-text">Привет, я</span>
            <span class="name-highlight">${profile.firstName} ${profile.lastName}</span>
          </h1>
          <p class="header-subtitle">Разработчик | Программист | Студент</p>
          <div class="header-badge">
            <span class="badge-icon">✨</span>
            <span>Добро пожаловать на мою страницу</span>
          </div>
        </div>
      </div>
    </header>
...
// Инициализация эффекта анимации
export function initProfileImageAnimation() {
